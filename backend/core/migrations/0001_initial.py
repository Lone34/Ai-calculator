    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.CharField(blank=True, choices=[('text', 'Text'), ('image', 'Image'), ('sketch', 'Sketch')], max_length=20, null=True)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interactions', to='core.mathsession')),
            ],
        ),
        migrations.CreateModel(
            name='UserPreference',
            fields=[
                ...
                ('preferred_llm', models.CharField(default='gpt-4o', max_length=50)),
